...
<%! public int count()
{
   Random randomGenerator = new Random();
    ...
    <header>
            ...
            <li> 
                <a href="cabfeatures.jsp">Cab Features</a>
            </li>
            <li> 
                <a href="chargedetails.jsp" >Charge Details</a> 
            </li>
    </header>
    ...
    <center><h3>FILL THIS FORM TO REQUEST A CAB</h3></center>
        ...
        <form:form name="login" action="./insert.htm" method="post" commandName="cmdEmp">
		...
		<tr>
			<td>SERVICES</td>
			<td>
			<input id="urgent" type="radio" name="type" value="URGENT" onclick="disableElement(this.form.elements['date']);" /> URGENT  
                        <input id="normal" type="radio" name="type" value="NORMAL" onclick="enableElement(this.form.elements['date']);" /> NORMAL	</td>	
